  ...
  endstops.enable(true); // Enable endstops for next homing move
    ...
    if (z_homing_height && (LINEAR_AXIS_GANG(doX, || doY, || TERN0(Z_SAFE_HOMING, doZ), || doI, || doJ, || doK))) {
      ...
      if(gb_emergency_stop)
      {
          ...
          // current_position._e = 0;
          // current_position.pos[0] = 0;
          // current_position.pos[1] = 0;
          // current_position.pos[2] = 0;
          // current_position.pos[3] = 0;
          gb_emergency_stop = false;
      }
      if(g_emergency_endstop)
      {
        // queue.inject("G92 X0 Y0 Z0");
        // g_emergency_home = true;
        return;
      }
