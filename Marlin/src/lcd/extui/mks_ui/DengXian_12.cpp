...
static uint8_t __g_font_buf[136];

static uint8_t *__user_font_getdata(int offset, int size) {
  get_spi_flash_data_16((char *)__g_font_buf, offset, size);
  return __g_font_buf;
}
...
lv_font_t DengXian_12;
void init_DengXian_12() {
  DengXian_12.get_glyph_bitmap = __user_font_get_bitmap;
  DengXian_12.get_glyph_dsc = __user_font_get_glyph_dsc;
  DengXian_12.line_height = 17;
  DengXian_12.base_line = 0;
}
