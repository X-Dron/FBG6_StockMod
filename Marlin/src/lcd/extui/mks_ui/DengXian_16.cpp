...
static uint8_t __g_font_buf[242];

static uint8_t *__user_font_getdata(int offset, int size) {
  get_spi_flash_data_22((char *)__g_font_buf, offset, size);
  return __g_font_buf;
}
...
lv_font_t DengXian_16;
void init_DengXian_16() {
  DengXian_16.get_glyph_bitmap = __user_font_get_bitmap;
  DengXian_16.get_glyph_dsc = __user_font_get_glyph_dsc;
  DengXian_16.line_height = 22;
  DengXian_16.base_line = 0;
}
