...
static uint8_t __g_font_buf[392];

static uint8_t *__user_font_getdata(int offset, int size) {
  get_spi_flash_data_28((char *)__g_font_buf, offset, size);
  return __g_font_buf;
}
...
lv_font_t DengXian_20;
void init_DengXian_20() {
  DengXian_20.get_glyph_bitmap = __user_font_get_bitmap;
  DengXian_20.get_glyph_dsc = __user_font_get_glyph_dsc;
  DengXian_20.line_height = 28;
  DengXian_20.base_line = 0;
}
