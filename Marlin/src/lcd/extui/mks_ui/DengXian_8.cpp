...
static uint8_t __g_font_buf[72];

static uint8_t *__user_font_getdata(int offset, int size) {
  get_spi_flash_data_12((char *)__g_font_buf, offset, size);
  return __g_font_buf;
}
...
lv_font_t DengXian_8;
void init_DengXian_8() {
  DengXian_8.get_glyph_bitmap = __user_font_get_bitmap;
  DengXian_8.get_glyph_dsc = __user_font_get_glyph_dsc;
  DengXian_8.line_height = 12;
  DengXian_8.base_line = 0;
}
