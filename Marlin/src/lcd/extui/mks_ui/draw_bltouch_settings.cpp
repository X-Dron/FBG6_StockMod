  ...
  switch (obj->mks_obj_id) {
    ...
    case ID_BLTOUCH_TEST:
      ...
      if (queue.ring_buffer.empty()) {
        gcode.process_subcommands_now(PSTR(str_1));
        zoffset_diff = 0;
      }
#endif
      break;
...
#ifdef MKS_DEBUG
static lv_obj_t *add_imgbtn = NULL;
static lv_obj_t *dec_imgbtn = NULL;

static lv_obj_t *test_imgbtn = NULL;
static lv_obj_t *test_label = NULL;
static lv_obj_t *save_imgbtn = NULL;
static lv_obj_t *back_imgbtn = NULL;
#endif
...
void lv_draw_bltouch_settings(void) {
  ...
  add_imgbtn = lv_big_button_create(scr, "F:/bmp_Add.bin", machine_menu.BLTouchOffsetpos, INTERVAL_V, titleHeight, event_handler, ID_BLTOUCH_ZOFFSETPOS);
  dec_imgbtn = lv_big_button_create(scr, "F:/bmp_Dec.bin", machine_menu.BLTouchOffsetneg, BTN_X_PIXEL * 3 + INTERVAL_V * 4, titleHeight, event_handler, ID_BLTOUCH_ZOFFSETNEG);
  ...
  test_imgbtn = lv_imgbtn_create(scr, "F:/bmp_in.bin", BTN_X_PIXEL + INTERVAL_V * 2, BTN_Y_PIXEL + INTERVAL_H + titleHeight, event_handler, ID_BLTOUCH_TEST);
  test_label = lv_label_create(scr, machine_menu.BLTouchTest);
  lv_obj_align(test_label, test_imgbtn, LV_ALIGN_IN_BOTTOM_MID, 0, BUTTON_TEXT_Y_OFFSET);
  save_imgbtn = lv_big_button_create(scr, "F:/bmp_set.bin", machine_menu.BLTouchSave, BTN_X_PIXEL * 2 + INTERVAL_V * 3, BTN_Y_PIXEL + INTERVAL_H + titleHeight, event_handler, ID_BLTOUCH_SAVE);
  back_imgbtn = lv_big_button_create(scr, "F:/bmp_return.bin", common_menu.text_back, BTN_X_PIXEL * 3 + INTERVAL_V * 4, BTN_Y_PIXEL + INTERVAL_H + titleHeight, event_handler, ID_BLTOUCH_RETURN);
  ...
  lv_imgbtn_set_src_both(add_imgbtn, "F:/bmp_Add.bin");
  lv_imgbtn_set_src_both(dec_imgbtn, "F:/bmp_Dec.bin");
  ...
  lv_imgbtn_set_src_both(test_imgbtn, "F:/bmp_in.bin");
  lv_imgbtn_set_src_both(save_imgbtn, "F:/bmp_set.bin");
  lv_imgbtn_set_src_both(back_imgbtn, "F:/bmp_return.bin");
