...
void lv_draw_ready_print() {
  ...
  ready_print_page.tool_imgbrn = lv_imgbtn_label_align_create(mks_printer.user_src, "F:/png_tool.bin", main_menu.tool,LV_ALIGN_IN_BOTTOM_LEFT, READY_IMGBTN_FIRST_X, READY_IMGBTN_FIRST_Y + READY_IMGBTN_H*2 + READY_IMGBTN_Y*2,10, 0, event_handler, ID_TOOL);
