...
User_ui_style User_style;
User_ui_scr mks_printer;
...
extern lv_group_t *g;
lv_style_t test_font;
lv_style_t test_font_16;
lv_style_t test_font_12;
lv_style_t test_font_8;
lv_style_t test_font_20;
lv_style_t label_dialog_white;

void LCD_IO_WriteData(uint16_t RegValue);

bool x_min_triggered = false, x_max_triggered = false;
bool y_min_triggered = false, y_max_triggered = false;
bool z_min_triggered = false, z_max_triggered = false;
...
LV_FONT_DECLARE(DengXian_16)
LV_FONT_DECLARE(DengXian_12)
LV_FONT_DECLARE(DengXian_8)
LV_FONT_DECLARE(DengXian_20)

void tft_style_init() {
  lv_style_copy(&tft_style_scr, &lv_style_scr);
  tft_style_scr.body.main_color   = LV_COLOR_WHITE;
  tft_style_scr.body.grad_color   = LV_COLOR_WHITE;
  ...
  tft_style_label_pre.body.main_color = LV_COLOR_WHITE;
  tft_style_label_pre.body.grad_color = LV_COLOR_WHITE;
  tft_style_label_pre.text.color      = LV_COLOR_TEXT;
  tft_style_label_pre.text.sel_color  = LV_COLOR_TEXT;
  tft_style_label_rel.body.main_color = LV_COLOR_WHITE;
  tft_style_label_rel.body.grad_color = LV_COLOR_WHITE;
  tft_style_label_rel.text.color      = LV_COLOR_TEXT;
  tft_style_label_rel.text.sel_color  = LV_COLOR_TEXT;
  tft_style_label_pre.text.font       = &DengXian_20;//TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);
  tft_style_label_rel.text.font       = &DengXian_20;//TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);
  ...
  style_para_value_pre.body.main_color = LV_COLOR_WHITE;
  style_para_value_pre.body.grad_color = LV_COLOR_WHITE;
  style_para_value_pre.text.color      = LV_COLOR_TEXT;
  style_para_value_pre.text.sel_color  = LV_COLOR_TEXT;
  style_para_value_rel.body.main_color = LV_COLOR_WHITE;
  style_para_value_rel.body.grad_color = LV_COLOR_WHITE;
  style_para_value_rel.text.color      = LV_COLOR_BLACK;
  style_para_value_rel.text.sel_color  = LV_COLOR_BLACK;
  style_para_value_pre.text.font       = &DengXian_20;//TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);
  style_para_value_rel.text.font       = &DengXian_20;//TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);
  ...
  style_num_key_pre.text.font       = &DengXian_20;//TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);
  style_num_key_rel.text.font       = &DengXian_20;//TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);
  ...
  style_num_text.text.font         = &DengXian_20;//TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);
  ...
  style_sel_text.body.main_color   = LV_COLOR_WHITE;
  style_sel_text.body.grad_color   = LV_COLOR_WHITE;
  style_sel_text.text.color        = LV_COLOR_YELLOW;
  style_sel_text.text.sel_color    = LV_COLOR_YELLOW;
  style_sel_text.text.font         = &DengXian_20;//TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);
  ...
  style_para_value.body.border.color = LV_COLOR_WHITE;
  ...
  style_para_value.text.font         = &DengXian_20;//&TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);

  lv_style_copy(&style_para_back, &lv_style_plain);
  style_para_back.body.border.color = LV_COLOR_WHITE;
  ...
  style_para_back.text.font         = &DengXian_20;//&TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);
  ...
  style_btn_rel.text.font         = &DengXian_20;//&TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);
  ...
  style_btn_pr.text.font         = &DengXian_20;//&TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);
  ...
  lv_style_copy(&User_style.title_bg_style, &lv_style_scr);
  User_style.title_bg_style.body.grad_color = LV_COLOR_MAKE(0x42,0x85,0xf8);
  User_style.title_bg_style.body.main_color = LV_COLOR_MAKE(0x42,0x85,0xf8);

  lv_style_copy(&User_style.text_white_style, &lv_style_scr);
  User_style.text_white_style.text.color = LV_COLOR_WHITE;
  User_style.text_white_style.text.font         = &DengXian_20;//&lv_font_roboto_22;//TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);
  
  lv_style_copy(&User_style.ready_style, &User_style.text_white_style);
  User_style.ready_style.text.font         = &DengXian_16;

  lv_style_copy(&User_style.text_title_white_style, &lv_style_scr);
  User_style.text_title_white_style.text.color = LV_COLOR_WHITE;
  User_style.text_title_white_style.text.font         = &DengXian_20;//&lv_font_roboto_22;//TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_28);

  lv_style_copy(&User_style.text28_white_style, &lv_style_scr);
  User_style.text28_white_style.text.color = LV_COLOR_WHITE;
  User_style.text28_white_style.text.font  = &DengXian_20;//&lv_font_roboto_28;
  
  lv_style_copy(&User_style.text22_white_style, &lv_style_scr);
  User_style.text22_white_style.text.color = LV_COLOR_WHITE;
  User_style.text22_white_style.text.font  = &DengXian_20;//&lv_font_roboto_22;

  lv_style_copy(&User_style.text_black_style, &lv_style_scr);
  User_style.text_black_style.text.color = LV_COLOR_BLACK;
  User_style.text_black_style.text.font         = &DengXian_20;//&lv_font_roboto_22;//TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);

  lv_style_copy(&User_style.text_grey_style, &lv_style_scr);
  User_style.text_grey_style.text.color = LV_COLOR_GRAY;
  User_style.text_grey_style.text.font         = &DengXian_20;//&lv_font_roboto_22;//TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);



  lv_style_copy(&User_style.text28_black_style, &lv_style_scr);
  User_style.text28_black_style.text.color = LV_COLOR_BLACK;
  User_style.text28_black_style.text.font         = &DengXian_20;//&lv_font_roboto_28;

  lv_style_copy(&User_style.text22_black_style, &lv_style_scr);
  User_style.text22_black_style.text.color        = LV_COLOR_BLACK;
  User_style.text22_black_style.text.font         = &DengXian_20;//&lv_font_roboto_22;

  lv_style_copy(&User_style.en_text_white_style, &lv_style_scr);
  User_style.en_text_white_style.text.color = LV_COLOR_WHITE;
  User_style.en_text_white_style.text.font         = &DengXian_16;//&lv_font_roboto_16;//&TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);
  lv_style_copy(&User_style.en_text_black_style, &lv_style_scr);
  User_style.en_text_black_style.text.color = LV_COLOR_BLACK;
  User_style.en_text_black_style.text.font         = &DengXian_16;//&lv_font_roboto_16;//&TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);


  lv_style_copy(&User_style.my_text_white_style, &lv_style_scr);
  User_style.my_text_white_style.text.color = LV_COLOR_WHITE;
  User_style.my_text_white_style.text.font         = &DengXian_16;//&TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);


  lv_style_copy(&User_style.my_text_black_style, &lv_style_scr);
  User_style.my_text_black_style.text.color = LV_COLOR_BLACK;
  User_style.my_text_black_style.text.font         = &DengXian_20;//&TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);

  lv_style_copy(&test_font, &User_style.my_text_black_style);
  test_font.text.font         = &gb2312_puhui32;
  
  lv_style_copy(&test_font_16, &User_style.my_text_black_style);
  test_font_16.text.font         = &DengXian_16;

  lv_style_copy(&label_dialog_white, &User_style.my_text_black_style);
  label_dialog_white.text.color         = LV_COLOR_WHITE;
  
  lv_style_copy(&test_font_12, &User_style.my_text_black_style);
  test_font_12.text.font         = &DengXian_12;
  
  lv_style_copy(&test_font_8, &User_style.my_text_black_style);
  test_font_8.text.font         = &DengXian_8;
  
  lv_style_copy(&test_font_20, &User_style.my_text_black_style);
  test_font_20.text.font         = &DengXian_20;

  lv_style_copy(&User_style.small_text_black_style, &lv_style_scr);
  User_style.small_text_black_style.text.color = LV_COLOR_BLACK;
  User_style.small_text_black_style.text.font         = &DengXian_16;//&lv_font_roboto_16;
  ...
  User_style.small_text_white_style.text.font         = &DengXian_12;//&lv_font_roboto_12;

  lv_style_copy(&User_style.level_bg_style, &lv_style_scr);
  User_style.level_bg_style.body.main_color = LV_COLOR_MAKE(0xEC,0xEC,0xEC);
  User_style.level_bg_style.body.grad_color = LV_COLOR_MAKE(0xEC,0xEC,0xEC);

  lv_style_copy(&User_style.rec_btn1_bg_style, &lv_style_scr);
  User_style.rec_btn1_bg_style.body.main_color = LV_COLOR_BLACK;//LV_COLOR_MAKE(0x18,0xa2,0x63);
  User_style.rec_btn1_bg_style.body.grad_color = LV_COLOR_BLACK;//LV_COLOR_MAKE(0x18,0xa2,0x63);
  User_style.rec_btn1_bg_style.body.radius = 5;
  // User_style.rec_btn1_bg_style.body.opa = 255;

  lv_style_copy(&User_style.rec_btn2_bg_style, &lv_style_scr);
  User_style.rec_btn2_bg_style.body.main_color = LV_COLOR_BLACK;//LV_COLOR_MAKE(0xff,0xa2,0x10);
  User_style.rec_btn2_bg_style.body.grad_color = LV_COLOR_BLACK;//LV_COLOR_MAKE(0xff,0xa2,0x10);
  User_style.rec_btn2_bg_style.body.radius = 5;
  // User_style.rec_btn2_bg_style.body.opa = 255;
  lv_style_copy(&User_style.style_blue_btn, &lv_style_scr);
  User_style.rec_btn2_bg_style.body.main_color = LV_COLOR_MAKE(0x42,0x85,0xf8);//LV_COLOR_MAKE(0xff,0xa2,0x10);
  User_style.rec_btn2_bg_style.body.grad_color = LV_COLOR_MAKE(0x42,0x85,0xf8);//LV_COLOR_MAKE(0xff,0xa2,0x10);
}
...
char *creat_title_text() {
  ...
  void gcode_preview(char *path, int xpos_pixel, int ypos_pixel) {
      ...
      for (i = 0; i < 400; i += 2) {
        ...
        if (*p_index == 0x0000) *p_index = LV_COLOR_WHITE.full;
      }
  ...
  void disp_pre_gcode(int xpos_pixel, int ypos_pixel) {
    ...
    {
      if(recoveryed_flag)
            gcode_preview(list_file.long_name[sel_id], xpos_pixel, ypos_pixel);
      else
...
void GUI_RefreshPage() {
  ...
  print_tone_sound_end();
  no_filament_sound_end();
  endstop_sound_end();
  lv_flame();
  if(READ(MT_DET_1_PIN) == MT_DET_PIN_STATE)
  {
    no_filament_sound_start();
  }
  // if(advances_data.flame_flag)
  // {
  //   if(!READ(MT_DET_2_PIN)) //火焰报警器触发
  //   {
  //     if(thermalManager.wholeDegHotend(0) >= 300)
  //     {
  ...
  {
    if((digitalRead(Y_MIN_PIN)) && !y_min_triggered)
    {
      y_min_triggered = true;
      endstop_sound_start();
    }
    if(!digitalRead(Y_MIN_PIN))
    {
      y_min_triggered = false;
    }
  }
  if(Y_MIN_ENDSTOP_INVERTING)
  {
 ...
 if(!X_MIN_ENDSTOP_INVERTING)
  {
    if((digitalRead(X_MIN_PIN)) && !x_min_triggered)
    {
      x_min_triggered = true;
      endstop_sound_start();
    }
    if(!digitalRead(X_MIN_PIN))
    {
      x_min_triggered = false;
    }
  }
 if(X_MIN_ENDSTOP_INVERTING)
  {
  ...
  {
    if((digitalRead(Z_MIN_PIN)) && !z_min_triggered)
    {
      z_min_triggered = true;
      endstop_sound_start();
    }
    if(!digitalRead(Z_MIN_PIN))
    {
      z_min_triggered = false;
    }
  }
  if(Z_MIN_ENDSTOP_INVERTING)
  {
  ...
  switch (disp_state) {
    ...
    case PRINTING_UI:
      if (temps_update_flag) {
        ...
        // {
        //   if(advances_data.fan5051_flag)
        //   {
        //     if(thermalManager.wholeDegHotend(0) >= PREHEAT_2_TEMP_HOTEND)
        //     {
...
void clear_cur_ui() {
  ...
  switch (disp_state_stack._disp_state[disp_state_stack._disp_index]) {
    ...
    case SIMPLE_KB_UI:                mks_clear_simple_num_kb();break;
...
void draw_return_ui() {
  if (disp_state_stack._disp_index > 0) {
    ...
    switch (disp_state_stack._disp_state[disp_state_stack._disp_index]) {
      ...
      #endif
      case MORE_UI:                     lv_draw_more(); break;
...
void LV_TASK_HANDLER() {
  ...
  TERN_(HAS_GCODE_PREVIEW, disp_pre_gcode(60, 19));
...
lv_obj_t *lv_title_offset_n_create(lv_obj_t *par, const char *text,lv_coord_t num)
{
  lv_obj_t *obj = lv_obj_create(par,NULL);
  lv_obj_set_pos(obj, 0, 0);
  lv_obj_set_size(obj,320,42);
  lv_obj_set_style(obj,&User_style.title_bg_style);
  if(text != nullptr)
  {
    lv_obj_t *label = lv_label_create_empty(obj);
    lv_label_set_text(label,text);
...
char *get_title_text(DISP_STATE index) {
  ...
  switch (index) {
    case TEMPSETTING_UI:      strcpy(public_buf_l, tempsetting_menu.title); break;
    case ENDSTOP_UI:          strcpy(public_buf_l, endstop_menu.title); break;
    case VOICE_UI:            strcpy(public_buf_l, voice_menu.title); break;
    case PRINT_READY_UI:      strcpy(public_buf_l, main_menu.title); break;
    case PRINT_FILE_UI:       strcpy(public_buf_l, file_menu.title); break;
    case ADVANCES_UI:         strcpy(public_buf_l, advances_menu.title); break;
    case PRINTING_UI:
      switch (disp_state_stack._disp_state[disp_state_stack._disp_index]) {
        IF_DISABLED(TFT35, case OPERATE_UI: case PAUSE_UI:)
        case PRINTING_UI:     strcpy(public_buf_l, common_menu.print_special_title); break;
    ...
    case BABY_STEP_UI:        strcpy(public_buf_l, operation_menu.babystep); break;
    case EEPROM_SETTINGS_UI:  strcpy(public_buf_l, eeprom_menu.title); break;
    case MEDIA_SELECT_UI:      break;
    case LAYER_STOP_UI:       strcpy(public_buf_l, layout_menu.title);break;
    default: break;
  }
...
lv_obj_t* lv_label_align_create_n(lv_obj_t *par,const char *text, lv_align_t align, lv_coord_t w, lv_coord_t h,lv_align_t labelalign,lv_coord_t x, lv_coord_t y, lv_event_cb_t cb, const int id, lv_style_t *style,lv_style_t *lstyle) {
  lv_obj_t *btn = lv_btn_create(par, cb, id, style);
  lv_obj_set_size(btn, w, h);
  lv_obj_align(btn, par, align, x, y);
  lv_obj_t *label = lv_label_create_empty(par);
  // lv_label_set_long_mode(label, LV_LABEL_LONG_SROLL);     /*Circular scroll*/
...
lv_obj_t* lv_label_align_create(lv_obj_t *par,const char *text, lv_coord_t x, lv_coord_t y,lv_align_t align,  lv_style_t *style) {
  ...
  lv_obj_align(label, par, align, x, y);
  return label;
}
lv_obj_t *lv_title_create(lv_obj_t *par, const char *text)
{
  lv_obj_t *obj = lv_obj_create(par,NULL);
  lv_obj_set_pos(obj, 0, 0);
  ...
  if(text != nullptr)
  {
    lv_obj_t *label = lv_label_create_empty(obj);
    lv_label_set_text(label,text);
    lv_obj_align(label, obj, LV_ALIGN_IN_LEFT_MID, 10, 0);
...
{
  lv_obj_t *obj = lv_obj_create(par,NULL);
  lv_obj_set_style(obj,&User_style.show_bg_style);
...
lv_obj_t *lv_imgbtn_label_align_create(lv_obj_t *par, const char *img, const char *text,lv_align_t align, lv_coord_t x, lv_coord_t y,lv_coord_t label_x, lv_coord_t label_y, lv_event_cb_t cb, const int id)
  {
    ...
    lv_obj_t *label = lv_label_create_empty(par);
    lv_label_set_text(label,text);
    lv_obj_align(label, btn, align, label_x, label_y);
    // if(disp_state == PRINT_READY_UI)
    lv_label_set_style(label,LV_LABEL_STYLE_MAIN,&User_style.ready_style);
    // else
    // lv_label_set_style(label,LV_LABEL_STYLE_MAIN,&User_style.text_white_style);
    return btn;
  }
lv_obj_t *lv_label_align_img(lv_obj_t *par, const char *img, const char *text,lv_align_t align,lv_coord_t x, lv_coord_t y,lv_coord_t label_x, lv_coord_t label_y,lv_style_t * style)
{
  ...
  lv_obj_t *label = lv_label_create_empty(par);
  lv_label_set_text(label,text);
  lv_obj_align(label, obj, align, label_x, label_y);
  lv_label_set_style(label,LV_LABEL_STYLE_MAIN,style);
  return label;
}
...
{
  label = lv_label_create_empty(par);
  lv_label_set_text(label,text);
  lv_obj_align(label, obj, align, label_x, label_y);
  lv_label_set_style(label,LV_LABEL_STYLE_MAIN,style);
  return label;
...
lv_obj_t* lv_btn_sim_align_create(lv_obj_t *par,lv_obj_t *btn, lv_align_t align, lv_coord_t w, lv_coord_t h,lv_coord_t x, lv_coord_t y, lv_event_cb_t cb, const int id, lv_style_t *style) {
  btn = lv_btn_create(par, cb, id, style);
  lv_obj_set_size(btn, w, h);
  lv_obj_align(btn, par, align, x, y);
  return btn;
}
...
lv_obj_t* label_for_imgbtn_name_mil_circ(lv_obj_t* scr, lv_obj_t* lab, lv_obj_t* base, lv_coord_t x, lv_coord_t y, const char* text,lv_style_t *style) {
    lab = lv_label_create(scr,  (lv_obj_t*)nullptr);
    lv_label_set_long_mode(lab, LV_LABEL_LONG_SROLL);
    // lv_obj_set_width(lab, w);
    lv_obj_set_size(lab, 150, 25);
    lv_label_set_recolor(lab, true);
    lv_label_set_text(lab, text);
    lv_label_set_align(lab ,LV_LABEL_ALIGN_LEFT);
    lv_obj_align(lab, base, LV_ALIGN_IN_LEFT_MID, x, y);
    lv_label_set_style(lab,LV_LABEL_STYLE_MAIN,style);
    return lab;
}
lv_obj_t* lv_region_style_align_create(lv_obj_t *par,const char *text,lv_coord_t w, lv_coord_t h, lv_align_t align, lv_coord_t x, lv_coord_t y, lv_style_t *style, lv_event_cb_t cb, const int id) {
  lv_obj_t *region = lv_btn_create(par, cb, id, NULL);
  lv_obj_set_size(region, w, h);
  lv_obj_align(region, par, align, x, y);
  lv_obj_set_style(region,style);
  lv_obj_t *label = lv_label_create_empty(par);
  lv_label_set_text(label,text);
  lv_label_set_style(label,LV_LABEL_STYLE_MAIN,&User_style.my_text_black_style);
  lv_obj_align(label, region, LV_ALIGN_CENTER, 0, 0);
  return label;
}
