...
#define PER_FONT_MAX_SPACE              (16 * 1024)
  ...
  #define UNIGBK_FLASH_ADDR            (FONTINFOADDR + 4096) // 4*1024
  #define GBK_FLASH_ADDR               (UNIGBK_FLASH_ADDR + 253952) // 176*1024

  #define FONTINFOADDR_22              GBK_FLASH_ADDR
  #define UNIGBK_FLASH_ADDR_22         (FONTINFOADDR_22 + 4096)
  #define GBK_FLASH_ADDR_22            (UNIGBK_FLASH_ADDR_22 + 253952)
  
  #define FONTINFOADDR_16              GBK_FLASH_ADDR_22
  #define UNIGBK_FLASH_ADDR_16         (FONTINFOADDR_16 + 4096)
  #define GBK_FLASH_ADDR_16            (UNIGBK_FLASH_ADDR_16 + 253952)
  
  #define FONTINFOADDR_12              GBK_FLASH_ADDR_16
  #define UNIGBK_FLASH_ADDR_12         (FONTINFOADDR_12 + 4096)
  #define GBK_FLASH_ADDR_12            (UNIGBK_FLASH_ADDR_12 + 194560)
  
  #define FONTINFOADDR_28              GBK_FLASH_ADDR_12
  #define UNIGBK_FLASH_ADDR_28         (FONTINFOADDR_28 + 4096)
  #define GBK_FLASH_ADDR_28            (UNIGBK_FLASH_ADDR_28 + 308224)
#endif
...
#define FLASH_INF_VALID_FLAG            0x20220617
