...
endstop_menu_def             endstop_menu;
tempsetting_menu_def         tempsetting_menu;
advances_menu_def            advances_menu;
layout_menu_def              layout_menu;
...
void disp_language_init() {
  preheat_menu.value_state = TEXT_TEMP_VALUE;
  ...
  switch (gCfgItems.language) {
    case LANG_SIMPLE_CHINESE:
      ...
      main_menu.filament     = FILAMENT_TEXT_CN;
      main_menu.emergency     = EMERGENCY_TEXT_CN;

      layout_menu.title      = LAYOUT_TEXT_CN;
      ...
      tool_menu.tempsetting  = TOOL_TEMPSETING_CN;
      tool_menu.wifi  = TOOL_WIFI_CN;
      tool_menu.advances  = TOOL_ADVANCES_CN;

      tool_menu.endstop  = TOOL_ENDSTOP_CN;
      tool_menu.voice  = TOOL_VOICE_CN;
      tool_menu.language  = TOOL_LANGUAGE_CN;
      tool_menu.about  = TOOL_ABOUT_CN;

      operation_menu.babystep = TEXT_BABY_STEP_CH;
      ...
      endstop_menu.title = ENDSTOP_TITLE_CN;
      endstop_menu.open = ENDSTOP_OPEN_CN;
      endstop_menu.trigger = ENDSTOP_TRIGGER_CN;
      endstop_menu.x_endstop = ENDSTOP_X_ENDSTOP_CN;
      endstop_menu.y_endstop = ENDSTOP_Y_ENDSTOP_CN;
      endstop_menu.z_endstop = ENDSTOP_Z_ENDSTOP_CN;
      endstop_menu.det_break = ENDSTOP_DET_BREAK_CN;
      endstop_menu.flame_sensor = ENDSTOP_FLAME_SENSOR_CN;
    
      advances_menu.title = ADVANCES_TITLE_CN;
      advances_menu.floodlight = ADVANCES_FLOODLIGHT_CN;
      advances_menu.fan5051 = ADVANCES_5051FAN_CN;
      advances_menu.flame_alarm = ADVANCES_FLAME_ALARM_CN;


      voice_menu.title = VOICE_TITLE_CN;
      voice_menu.btn_sound = VOICE_BTN_SOUND_CN;
      voice_menu.endstop_sound = VOICE_ENDSTOP_SOUND_CN;
      voice_menu.print_tone_sound = VOICE_PRINT_TONE_SOUND_CN;
      voice_menu.no_filament_tone_sound = VOICE_NO_FILAMENT_SOUND_CN;


      tempsetting_menu.title = TEMPSETTING_TITLE_CN;
      tempsetting_menu.pla = TEMPSETTING_PLA_CN;
      tempsetting_menu.abs = TEMPSETTING_ABS_CN;
      tempsetting_menu.ex1 = TEMPSETTING_EX1_CN;
      tempsetting_menu.bed = TEMPSETTING_BED_CN;

      preheat_menu.value_state = TEXT_TEMP_VALUE_CN;
      ...
      move_menu.layout_stop         = TEXT_LAYER_STOP_CN;
      ...
      dialog_menu.recovery_continue_btn = DIALONG_RECOVERY_COMTINUE_BTN_CN;
      dialog_menu.recovery_back_btn = DIALONG_RECOVERY_BACK_BTN_CN;
      dialog_menu.complete_btn = DIALOG_COMPLETE_BTN_CN;
      dialog_menu.print_again = DIALOG_PRINT_AGAIN_BTN_CN;
      printing_menu.z_offset = PRINTING_Z_OFFSET_CN;
      dialog_menu.add_filament = ADD_FILAMENT_CN;
      ...
      wifi_menu.info_text = WIFI_INFO_TEXT_CH;
      wifi_menu.link_overtime_text = WIFI_LINK_OVERTIME_CH;
        // CLOUD
      ...
      about_menu.title   = ABOUT_TITLE_CN;
      about_menu.size    = ABOUT_SZIE_CN;
      about_menu.model   = ABOUT_MODEL_CN;
      about_menu.diameter=   ABOUT_DIAMETER_CN;
      about_menu.voltage =   ABOUT_VOLTAGE_CN;  
      about_menu.version =   ABOUT_VERSIZON_CN; 
      about_menu.support =   ABOUT_SUPPORT_CN; 
      about_menu.sales   =   ABOUT_SALES_CN; 
      //
      ...
      filament_menu.heating_nozzle                      = HEATING_NOZZLE_CN;
      filament_menu.stop                                = FILAMENT_STOP_TEXT_CN;
      ...
      dialog_menu.emergency_text1 = DIALOG_EMERGENCY_TEXT1_CH;
      dialog_menu.emergency_text2 = DIALOG_EMERGENCY_TEXT2_CH;
      dialog_menu.emergency_text3 = DIALOG_EMERGENCY_TEXT3_CH;
      dialog_menu.emergency_text4 = DIALOG_EMERGENCY_TEXT4_CH;
      dialog_menu.no_filament_text1 = DIALOG_NO_FILAMENT_TEXT1_CH;
      dialog_menu.no_filament_text2 = DIALOG_NO_FILAMENT_TEXT2_CH;
      dialog_menu.no_filament_text3 = DIALOG_NO_FILAMENT_TEXT3_CH;
      ...
      break;
          ...
          case LANG_COMPLEX_CHINESE:
            ...
            preheat_menu.value_state  = TEXT_TEMP_VALUE_T_CN;
          ...
          case LANG_ENGLISH:
            ...
            main_menu.filament     = FILAMENT_TEXT_EN;
            ...
            filament_menu.heating_nozzle                      = HEATING_NOZZLE_EN;
            filament_menu.stop                                = FILAMENT_STOP_TEXT_EN;
